    ...
    <div className="page-section home-page reference-home">
      <section className="reference-hero" aria-labelledby="hero-title">
        <div className="reference-hero__copy">
          ...
          <h1 id="hero-title">The 12th House</h1>
